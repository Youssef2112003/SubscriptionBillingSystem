namespace SPS.Domain.MetaData
{
    public static class Router
    {
        ...
        public static class Authentication
        {
            ...
            public const string LogoutUser = Prefix + "/LogoutUser";
        ...
        public static class EmployeeRouting
        {
            ...
            public const string GetByID = Prefix + SignleRoute;
            public const string GetByDepartment = Prefix + "/Department/{departmentId}";
            public const string Create = Prefix + "/Create";
            public const string Edit = Prefix + "/Edit";
            public const string Delete = Prefix + "/{Id}";
            public const string Paginated = Prefix + "/Paginated";
        ...
        public static class SMSRoute
        {
            public const string Prefix = Rule + "SMSRoute";
